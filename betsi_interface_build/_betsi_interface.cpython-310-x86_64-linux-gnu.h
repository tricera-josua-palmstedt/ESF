...
/* package github.com/tricera-josua-palmstedt/ESF/betsi_interface_build */
...
//
extern long long int betsi_interface_BatteryPowerControl_CTor();
extern double betsi_interface_BatteryPowerControl_P_Get(long long int handle);
extern void betsi_interface_BatteryPowerControl_P_Set(long long int handle, double val);
extern double betsi_interface_BatteryPowerControl_PSet_Get(long long int handle);
extern void betsi_interface_BatteryPowerControl_PSet_Set(long long int handle, double val);
extern long long unsigned int betsi_interface_BatteryPowerControl_PPriority_Get(long long int handle);
extern void betsi_interface_BatteryPowerControl_PPriority_Set(long long int handle, long long unsigned int val);
extern double betsi_interface_BatteryPowerControl_Q_Get(long long int handle);
extern void betsi_interface_BatteryPowerControl_Q_Set(long long int handle, double val);
extern double betsi_interface_BatteryPowerControl_Soc_Get(long long int handle);
extern void betsi_interface_BatteryPowerControl_Soc_Set(long long int handle, double val);
extern double betsi_interface_BatteryPowerControl_SocMax_Get(long long int handle);
extern void betsi_interface_BatteryPowerControl_SocMax_Set(long long int handle, double val);
extern double betsi_interface_BatteryPowerControl_SocMin_Get(long long int handle);
extern void betsi_interface_BatteryPowerControl_SocMin_Set(long long int handle, double val);
extern double betsi_interface_BatteryPowerControl_PMax_Get(long long int handle);
extern void betsi_interface_BatteryPowerControl_PMax_Set(long long int handle, double val);
extern double betsi_interface_BatteryPowerControl_PMin_Get(long long int handle);
extern void betsi_interface_BatteryPowerControl_PMin_Set(long long int handle, double val);
extern double betsi_interface_BatteryPowerControl_ENom_Get(long long int handle);
extern void betsi_interface_BatteryPowerControl_ENom_Set(long long int handle, double val);

// --- wrapping struct: betsi_interface.LoadPowerControl ---
//
extern long long int betsi_interface_LoadPowerControl_CTor();
extern double betsi_interface_LoadPowerControl_P_Get(long long int handle);
extern void betsi_interface_LoadPowerControl_P_Set(long long int handle, double val);
extern double betsi_interface_LoadPowerControl_PSet_Get(long long int handle);
extern void betsi_interface_LoadPowerControl_PSet_Set(long long int handle, double val);
extern long long unsigned int betsi_interface_LoadPowerControl_PPriority_Get(long long int handle);
extern void betsi_interface_LoadPowerControl_PPriority_Set(long long int handle, long long unsigned int val);
extern double betsi_interface_LoadPowerControl_Q_Get(long long int handle);
extern void betsi_interface_LoadPowerControl_Q_Set(long long int handle, double val);
extern double betsi_interface_LoadPowerControl_PMax_Get(long long int handle);
extern void betsi_interface_LoadPowerControl_PMax_Set(long long int handle, double val);
extern double betsi_interface_LoadPowerControl_PMin_Get(long long int handle);
extern void betsi_interface_LoadPowerControl_PMin_Set(long long int handle, double val);
extern double betsi_interface_LoadPowerControl_PFromGrid_Get(long long int handle);
extern void betsi_interface_LoadPowerControl_PFromGrid_Set(long long int handle, double val);
extern double betsi_interface_LoadPowerControl_PConsumptionMin_Get(long long int handle);
extern void betsi_interface_LoadPowerControl_PConsumptionMin_Set(long long int handle, double val);

// --- wrapping struct: betsi_interface.PvPowerControl ---
//
extern long long int betsi_interface_PvPowerControl_CTor();
extern double betsi_interface_PvPowerControl_P_Get(long long int handle);
extern void betsi_interface_PvPowerControl_P_Set(long long int handle, double val);
extern double betsi_interface_PvPowerControl_PSet_Get(long long int handle);
extern void betsi_interface_PvPowerControl_PSet_Set(long long int handle, double val);
extern long long unsigned int betsi_interface_PvPowerControl_PPriority_Get(long long int handle);
extern void betsi_interface_PvPowerControl_PPriority_Set(long long int handle, long long unsigned int val);
extern double betsi_interface_PvPowerControl_Q_Get(long long int handle);
extern void betsi_interface_PvPowerControl_Q_Set(long long int handle, double val);
extern double betsi_interface_PvPowerControl_PMax_Get(long long int handle);
extern void betsi_interface_PvPowerControl_PMax_Set(long long int handle, double val);
extern double betsi_interface_PvPowerControl_PMin_Get(long long int handle);
extern void betsi_interface_PvPowerControl_PMin_Set(long long int handle, double val);
