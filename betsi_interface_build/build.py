# python build stubs for package betsi_interface
...
mod = Module('_betsi_interface')
mod.add_include('"betsi_interface_go.h"')
...
mod.add_function('betsi_interface_BatteryPowerControl_CTor', retval('int64_t'), [])
mod.add_function('betsi_interface_BatteryPowerControl_P_Get', retval('double'), [param('int64_t', 'handle')])
mod.add_function('betsi_interface_BatteryPowerControl_P_Set', None, [param('int64_t', 'handle'), param('double', 'val')])
mod.add_function('betsi_interface_BatteryPowerControl_PSet_Get', retval('double'), [param('int64_t', 'handle')])
mod.add_function('betsi_interface_BatteryPowerControl_PSet_Set', None, [param('int64_t', 'handle'), param('double', 'val')])
mod.add_function('betsi_interface_BatteryPowerControl_PPriority_Get', retval('uint64_t'), [param('int64_t', 'handle')])
mod.add_function('betsi_interface_BatteryPowerControl_PPriority_Set', None, [param('int64_t', 'handle'), param('uint64_t', 'val')])
mod.add_function('betsi_interface_BatteryPowerControl_Q_Get', retval('double'), [param('int64_t', 'handle')])
mod.add_function('betsi_interface_BatteryPowerControl_Q_Set', None, [param('int64_t', 'handle'), param('double', 'val')])
mod.add_function('betsi_interface_BatteryPowerControl_Soc_Get', retval('double'), [param('int64_t', 'handle')])
mod.add_function('betsi_interface_BatteryPowerControl_Soc_Set', None, [param('int64_t', 'handle'), param('double', 'val')])
mod.add_function('betsi_interface_BatteryPowerControl_SocMax_Get', retval('double'), [param('int64_t', 'handle')])
mod.add_function('betsi_interface_BatteryPowerControl_SocMax_Set', None, [param('int64_t', 'handle'), param('double', 'val')])
mod.add_function('betsi_interface_BatteryPowerControl_SocMin_Get', retval('double'), [param('int64_t', 'handle')])
mod.add_function('betsi_interface_BatteryPowerControl_SocMin_Set', None, [param('int64_t', 'handle'), param('double', 'val')])
mod.add_function('betsi_interface_BatteryPowerControl_PMax_Get', retval('double'), [param('int64_t', 'handle')])
mod.add_function('betsi_interface_BatteryPowerControl_PMax_Set', None, [param('int64_t', 'handle'), param('double', 'val')])
mod.add_function('betsi_interface_BatteryPowerControl_PMin_Get', retval('double'), [param('int64_t', 'handle')])
mod.add_function('betsi_interface_BatteryPowerControl_PMin_Set', None, [param('int64_t', 'handle'), param('double', 'val')])
mod.add_function('betsi_interface_BatteryPowerControl_ENom_Get', retval('double'), [param('int64_t', 'handle')])
mod.add_function('betsi_interface_BatteryPowerControl_ENom_Set', None, [param('int64_t', 'handle'), param('double', 'val')])
mod.add_function('betsi_interface_LoadPowerControl_CTor', retval('int64_t'), [])
mod.add_function('betsi_interface_LoadPowerControl_P_Get', retval('double'), [param('int64_t', 'handle')])
mod.add_function('betsi_interface_LoadPowerControl_P_Set', None, [param('int64_t', 'handle'), param('double', 'val')])
mod.add_function('betsi_interface_LoadPowerControl_PSet_Get', retval('double'), [param('int64_t', 'handle')])
mod.add_function('betsi_interface_LoadPowerControl_PSet_Set', None, [param('int64_t', 'handle'), param('double', 'val')])
mod.add_function('betsi_interface_LoadPowerControl_PPriority_Get', retval('uint64_t'), [param('int64_t', 'handle')])
mod.add_function('betsi_interface_LoadPowerControl_PPriority_Set', None, [param('int64_t', 'handle'), param('uint64_t', 'val')])
mod.add_function('betsi_interface_LoadPowerControl_Q_Get', retval('double'), [param('int64_t', 'handle')])
mod.add_function('betsi_interface_LoadPowerControl_Q_Set', None, [param('int64_t', 'handle'), param('double', 'val')])
mod.add_function('betsi_interface_LoadPowerControl_PMax_Get', retval('double'), [param('int64_t', 'handle')])
mod.add_function('betsi_interface_LoadPowerControl_PMax_Set', None, [param('int64_t', 'handle'), param('double', 'val')])
mod.add_function('betsi_interface_LoadPowerControl_PMin_Get', retval('double'), [param('int64_t', 'handle')])
mod.add_function('betsi_interface_LoadPowerControl_PMin_Set', None, [param('int64_t', 'handle'), param('double', 'val')])
mod.add_function('betsi_interface_LoadPowerControl_PFromGrid_Get', retval('double'), [param('int64_t', 'handle')])
mod.add_function('betsi_interface_LoadPowerControl_PFromGrid_Set', None, [param('int64_t', 'handle'), param('double', 'val')])
mod.add_function('betsi_interface_LoadPowerControl_PConsumptionMin_Get', retval('double'), [param('int64_t', 'handle')])
mod.add_function('betsi_interface_LoadPowerControl_PConsumptionMin_Set', None, [param('int64_t', 'handle'), param('double', 'val')])
mod.add_function('betsi_interface_PvPowerControl_CTor', retval('int64_t'), [])
mod.add_function('betsi_interface_PvPowerControl_P_Get', retval('double'), [param('int64_t', 'handle')])
mod.add_function('betsi_interface_PvPowerControl_P_Set', None, [param('int64_t', 'handle'), param('double', 'val')])
mod.add_function('betsi_interface_PvPowerControl_PSet_Get', retval('double'), [param('int64_t', 'handle')])
mod.add_function('betsi_interface_PvPowerControl_PSet_Set', None, [param('int64_t', 'handle'), param('double', 'val')])
mod.add_function('betsi_interface_PvPowerControl_PPriority_Get', retval('uint64_t'), [param('int64_t', 'handle')])
mod.add_function('betsi_interface_PvPowerControl_PPriority_Set', None, [param('int64_t', 'handle'), param('uint64_t', 'val')])
mod.add_function('betsi_interface_PvPowerControl_Q_Get', retval('double'), [param('int64_t', 'handle')])
mod.add_function('betsi_interface_PvPowerControl_Q_Set', None, [param('int64_t', 'handle'), param('double', 'val')])
mod.add_function('betsi_interface_PvPowerControl_PMax_Get', retval('double'), [param('int64_t', 'handle')])
mod.add_function('betsi_interface_PvPowerControl_PMax_Set', None, [param('int64_t', 'handle'), param('double', 'val')])
mod.add_function('betsi_interface_PvPowerControl_PMin_Get', retval('double'), [param('int64_t', 'handle')])
mod.add_function('betsi_interface_PvPowerControl_PMin_Set', None, [param('int64_t', 'handle'), param('double', 'val')])

mod.generate(open('betsi_interface.c', 'w'))
